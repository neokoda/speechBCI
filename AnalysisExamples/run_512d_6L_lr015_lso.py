#!/usr/bin/env python3
"""
Full training run: 512d_6L_8H_2048ff with LR=0.015 cosine + LossScaleOptimizer.

Tests whether 6 layers (deeper) improves over 4 layers (PER=0.2754).
6L 512d = ~20M params, matching GRU's ~21M.

Usage:
    python run_512d_6L_lr015_lso.py \
        --data-dir /workspace/speechBCI/data/derived/tfRecords \
        --output-dir /workspace/speechBCI/experiments/512d_6L_lr015_lso \
        --gpu 0
"""
...
CONFIG = {
    'name': 'transformer_512d_6L_8H_2048ff_lr015_lso',
    'd_model': 512, 'num_layers': 6, 'nhead': 8, 'd_ff': 2048,
}
...
BASELINE_512D_LR015_LSO_PER = 0.2754
...
def run(args):
    print(f"\n{'='*70}")
    print(f"  512d 6-LAYER MODEL TRAINING: LR=0.015 + LossScaleOptimizer")
    ...
    print(f"  512d 4L LR=0.015+LSO baseline PER: {BASELINE_512D_LR015_LSO_PER}")
    ...
    while True:
        ...
        try:
            ...
            print(f"  Compare: 512d 4L LR=0.015+LSO = {BASELINE_512D_LR015_LSO_PER} PER")
            ...
            result = {
                ...
                'baseline_512d_lr015_lso_per': BASELINE_512D_LR015_LSO_PER,
                'gru_baseline_per': GRU_BASELINE_PER,
            }
            with open(os.path.join(args.output_dir, '512d_6L_lr015_lso_result.json'), 'w') as f:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='512d 6L model training: LR=0.015 + LossScaleOptimizer')
    parser.add_argument('--data-dir', required=True)
    parser.add_argument('--output-dir', default='/workspace/speechBCI/experiments/512d_6L_lr015_lso')
