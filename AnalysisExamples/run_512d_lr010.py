...
CONFIG = {
    'name': 'transformer_512d_4L_8H_2048ff_lr010',
...
def run(args):
    print(f"\n{'='*70}")
    print(f"  512d MODEL TRAINING: LR=0.01 (stabilized)")
    ...
    print(f"  Grad clip: {FIXED['gradClipValue']}")
    ...
    while True:
        ...
        try:
            ...
            print(f"  Compare: 512d LR=0.015 = {BASELINE_512D_LR015_PER} PER")
            ...
            with open(os.path.join(args.output_dir, '512d_lr010_result.json'), 'w') as f:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='512d model training: LR=0.01 (stabilized)')
    parser.add_argument('--data-dir', required=True)
    parser.add_argument('--output-dir', default='/workspace/speechBCI/experiments/512d_lr010')
