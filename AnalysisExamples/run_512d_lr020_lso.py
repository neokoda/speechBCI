#!/usr/bin/env python3
"""
Full training run: 512d_4L_8H_2048ff with LR=0.02 cosine + LossScaleOptimizer.

Tests whether LR=0.02 (matching the GRU's LR) improves over LR=0.015 (PER=0.2754).

Usage:
    python run_512d_lr020_lso.py \
        --data-dir /workspace/speechBCI/data/derived/tfRecords \
        --output-dir /workspace/speechBCI/experiments/512d_lr020_lso \
        --gpu 0
"""
...
CONFIG = {
    'name': 'transformer_512d_4L_8H_2048ff_lr020_lso',
...
def run(args):
    print(f"\n{'='*70}")
    print(f"  512d MODEL TRAINING: LR=0.02 + LossScaleOptimizer")
    ...
    while True:
        ...
        try:
            ...
            with open(os.path.join(args.output_dir, '512d_lr020_lso_result.json'), 'w') as f:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='512d model training: LR=0.02 + LossScaleOptimizer')
    parser.add_argument('--data-dir', required=True)
    parser.add_argument('--output-dir', default='/workspace/speechBCI/experiments/512d_lr020_lso')
