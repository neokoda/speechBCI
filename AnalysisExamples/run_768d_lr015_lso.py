#!/usr/bin/env python3
"""
Full training run: 768d_4L_8H_3072ff with LR=0.015 cosine + LossScaleOptimizer.

Tests whether scaling to 768d (~36M params, larger than GRU's ~21M) improves
over 512d (PER=0.2754).

Usage:
    python run_768d_lr015_lso.py \
        --data-dir /workspace/speechBCI/data/derived/tfRecords \
        --output-dir /workspace/speechBCI/experiments/768d_lr015_lso \
        --gpu 0
"""
...
CONFIG = {
    'name': 'transformer_768d_4L_8H_3072ff_lr015_lso',
    'd_model': 768, 'num_layers': 4, 'nhead': 8, 'd_ff': 3072,
}
...
def run(args):
    print(f"\n{'='*70}")
    print(f"  768d MODEL TRAINING: LR=0.015 + LossScaleOptimizer")
    ...
    print(f"  512d LR=0.015+LSO baseline PER: {BASELINE_512D_LR015_LSO_PER}")
    ...
    while True:
        ...
        try:
            ...
            print(f"  Compare: 512d LR=0.015+LSO = {BASELINE_512D_LR015_LSO_PER} PER")
            ...
            with open(os.path.join(args.output_dir, '768d_lr015_lso_result.json'), 'w') as f:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='768d model training: LR=0.015 + LossScaleOptimizer')
    parser.add_argument('--data-dir', required=True)
    parser.add_argument('--output-dir', default='/workspace/speechBCI/experiments/768d_lr015_lso')
