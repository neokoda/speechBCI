...
CONFIG = {
    'name': 'conformer_512d_6L_specaug',
...
def run(args):
    print(f"\n{'='*70}")
    print(f"  CONFORMER 6-LAYER + SPECAUGMENT")
    ...
    print(f"  SpecAugment: ON | Gaussian Smoothing: ON")
    print(f"  Gradient Checkpointing: OFF")
    print(f"  Previous Conformer (4L) PER: {PREV_CONFORMER_PER}")
    ...
    while True:
        ...
        try:
            ...
            print(f"  Compare: Previous Conformer (4L) = {PREV_CONFORMER_PER} PER")
            ...
            with open(os.path.join(args.output_dir, 'conformer_6L_result.json'), 'w') as f:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Conformer 6-layer + SpecAugment')
    parser.add_argument('--data-dir', required=True)
    parser.add_argument('--output-dir', default='/workspace/speechBCI/experiments/conformer_6L')
