...
def run(args):
    print(f"\n{'='*70}")
    print(f"  CONFORMER + CONV KERNEL 63")
    ...
    while True:
        ...
        try:
            ...
            with open(os.path.join(args.output_dir, 'conformer_conv63_result.json'), 'w') as f:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Conformer + Conv Kernel 63')
    parser.add_argument('--data-dir', required=True)
    parser.add_argument('--output-dir', default='/workspace/speechBCI/experiments/conformer_conv63')
