...
CONFIG = {
    'name': 'conformer_512d_4L_dropout15',
...
def run(args):
    print(f"\n{'='*70}")
    print(f"  CONFORMER + DROPOUT 0.15")
    ...
    print(f"  Dropout: {CONFIG['dropout']} (up from 0.1)")
    ...
    while True:
        ...
        try:
            ...
            with open(os.path.join(args.output_dir, 'conformer_dropout15_result.json'), 'w') as f:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Conformer + dropout 0.15')
    parser.add_argument('--data-dir', required=True)
    parser.add_argument('--output-dir', default='/workspace/speechBCI/experiments/conformer_dropout15')
