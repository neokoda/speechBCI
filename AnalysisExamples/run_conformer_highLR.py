...
def run(args):
    print(f"\n{'='*70}")
    print(f"  CONFORMER + HIGH LR (0.025)")
    ...
    print(f"  Previous best PER: {PREV_CONFORMER_PER}")
    ...
    while True:
        ...
        try:
            ...
            print(f"  Compare: Previous best = {PREV_CONFORMER_PER} PER")
            ...
            result = {
                ...
                'prev_best_per': PREV_CONFORMER_PER,
                'gru_baseline_per': GRU_BASELINE_PER,
            }
            with open(os.path.join(args.output_dir, 'conformer_highLR_result.json'), 'w') as f:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Conformer + High LR')
    parser.add_argument('--data-dir', required=True)
    parser.add_argument('--output-dir', default='/workspace/speechBCI/experiments/conformer_highLR')
