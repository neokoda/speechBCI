...
CONFIG = {
    'name': 'conformer_512d_4L_higherLR',
...
def run(args):
    print(f"\n{'='*70}")
    print(f"  CONFORMER + HIGHER LR (0.04)")
    ...
    while True:
        ...
        try:
            ...
            with open(os.path.join(args.output_dir, 'conformer_higherLR_result.json'), 'w') as f:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Conformer + Higher LR')
    parser.add_argument('--data-dir', required=True)
    parser.add_argument('--output-dir', default='/workspace/speechBCI/experiments/conformer_higherLR')
