...
CONFIG = {
    'name': 'conformer_512d_4L_lowDropout',
...
def run(args):
    print(f"\n{'='*70}")
    print(f"  CONFORMER + LOW DROPOUT (0.05)")
    ...
    print(f"  Dropout: 0.05 (reduced from 0.1)")
    ...
    while True:
        ...
        try:
            ...
            with open(os.path.join(args.output_dir, 'conformer_lowDropout_result.json'), 'w') as f:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Conformer + Low Dropout')
    parser.add_argument('--data-dir', required=True)
    parser.add_argument('--output-dir', default='/workspace/speechBCI/experiments/conformer_low_dropout')
