...
CONFIG = {
    'name': 'conformer_512d_4L_specaug_nosmooth',
...
def run(args):
    print(f"\n{'='*70}")
    print(f"  CONFORMER + SPECAUGMENT + NO GAUSSIAN SMOOTHING")
    ...
    print(f"  SpecAugment: ON | Gaussian Smoothing: OFF")
    ...
    while True:
        ...
        try:
            ...
            with open(os.path.join(args.output_dir, 'conformer_no_smooth_result.json'), 'w') as f:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Conformer + SpecAugment + no Gaussian smoothing')
    parser.add_argument('--data-dir', required=True)
    parser.add_argument('--output-dir', default='/workspace/speechBCI/experiments/conformer_no_smooth')
