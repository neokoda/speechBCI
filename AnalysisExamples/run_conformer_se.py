...
def run(args):
    print(f"\n{'='*70}")
    print(f"  CONFORMER + SQUEEZE-AND-EXCITATION (r={CONFIG['se_reduction']})")
    ...
    print(f"  SE: reduction={CONFIG['se_reduction']}, "
          f"bottleneck={256 // CONFIG['se_reduction']}")
        ...
        try:
            ...
            result = {
                ...
                'squeeze_excitation': {
                    ...
                    'bottleneck': 256 // CONFIG['se_reduction'],
                },
                'best_per': per,
                'best_step': best_step,
            ...
            with open(os.path.join(args.output_dir, 'conformer_se_result.json'), 'w') as f:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Conformer + Squeeze-and-Excitation')
    parser.add_argument('--data-dir', required=True)
    parser.add_argument('--output-dir', default='/workspace/speechBCI/experiments/conformer_se')
