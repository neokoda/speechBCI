...
def run(args):
    print(f"\n{'='*70}")
    print(f"  CONFORMER + SE r={CONFIG['se_reduction']} — 24 SESSIONS")
    ...
    while True:
        ...
        try:
            ...
            with open(os.path.join(args.output_dir, 'conformer_se_24sess_result.json'), 'w') as f:
