...
def run(args):
    ...
    print(f"  Previous best (19 sess): {PREV_BEST_PER}")
    print(f"{'='*70}\n")
    ...
    while True:
        ...
        try:
            ...
            with open(os.path.join(args.output_dir, 'conformer_spatial_24sess_result.json'), 'w') as f:
