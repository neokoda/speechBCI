...
CONFIG = {
    'name': 'conformer_512d_4L_specaugment',
...
def run(args):
    ...
    print(f"  Previous Conformer PER: {PREV_CONFORMER_PER}")
    ...
    while True:
        ...
        try:
            ...
            print(f"  Compare: Previous Conformer = {PREV_CONFORMER_PER} PER")
            ...
            result = {
                ...
                'prev_conformer_per': PREV_CONFORMER_PER,
                'gru_baseline_per': GRU_BASELINE_PER,
            }
            with open(os.path.join(args.output_dir, 'conformer_specaugment_result.json'), 'w') as f:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Conformer + SpecAugment')
    parser.add_argument('--data-dir', required=True)
    parser.add_argument('--output-dir', default='/workspace/speechBCI/experiments/conformer_specaugment')
