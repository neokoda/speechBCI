...
CONFIG = {
    'name': 'transformer_256d_4L_8H_512ff_cosine',
...
def run(args):
    print(f"\n{'='*70}")
    print(f"  COSINE ANNEALING ABLATION: 256d model")
    ...
    while True:
        ...
        try:
            ...
            with open(os.path.join(args.output_dir, 'cosine_ablation_result.json'), 'w') as f:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Cosine Annealing Ablation')
    parser.add_argument('--data-dir', required=True)
    parser.add_argument('--output-dir', default='/workspace/speechBCI/experiments/cosine_ablation')
